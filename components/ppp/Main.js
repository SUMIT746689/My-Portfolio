...
function Main() {
  ...
  return (
    <div className='relative'>
      <main id='home' className='z-10 min-h-screen flex flex-col justify-center align-middle px-5 xs:pl-10 sm:pl-16 md:pl-24 xl:px-40 2xl:pl-52'>
        ...
        <div className='flex w-full flex-wrap text-xl xs:text-3xl sm:text-5xl md:text-5xl lg:text-7xl font-bold text-slate-600 '>
          <div className='flex flex-wrap'>{textAnimation(data)}</div>
