  ...
  return (
    <footer className=' bg-cyan-700 py-6 duration-150'>
        <div className='relative -top-20 text-center py-7 mx-auto w-5/6 bg-cyan-600 shadow-md shadow-slate-800 rounded-xl'>
          ...
          <button onClick={()=>setShowClientForm((value)=>!value)} className=' duration-150 text-gray-50 cursor-pointer border-2 bg-gradient-to-r from-cyan-400 to-blue-500 hover:from-blue-500 hover:to-cyan-400 px-7 py-3 text-xl font-mono font-semibold rounded-full'>
            {`Let's do this`}
          </button>
        </div>
